...
const nonBiasedReviewPrompt = ai.definePrompt({
  ...
  prompt: `
    ...
    **CRITICAL Instructions:**
    1.  **Score Strictly by Description**: This is your most important instruction. You MUST evaluate the agent's performance for each criterion based *exclusively* on its 'description'. The description is the absolute source of truth for what constitutes a good (5) or bad (0) score. Do NOT use your own general knowledge of customer service. If a description says profanity is good, you must score the use of profanity highly.
