...
const nonBiasedReviewPrompt = ai.definePrompt({
  ...
  prompt: `
    ...
    **CRITICAL Instructions:**
    1.  **Score Strictly by Description**: You MUST evaluate the agent's performance for each criterion based exclusively on its 'description', which includes a detailed 0-5 scoring guide. Do NOT use your own general knowledge of customer service.
