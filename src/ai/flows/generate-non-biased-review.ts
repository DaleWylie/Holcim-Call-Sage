...
const nonBiasedReviewPrompt = ai.definePrompt({
  ...
  prompt: `
    ...
    **CRITICAL Instructions:**
    ...
    4.  **Gender-Neutral Language**: You MUST NOT assume the gender of the agent. Use only their first name or gender-neutral pronouns (e.g., they, them, their) when referring to the agent.
