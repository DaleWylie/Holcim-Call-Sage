...
import { CheckCircle2, ListChecks, Printer, Sparkles, Target, Pencil, Check, X, UserCheck, Calendar, Fingerprint } from "lucide-react"
...
export function ReviewDisplay({ review, setReview }: ReviewDisplayProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-4 right-4 action-button">
        <Button onClick={handlePrint} disabled={isPrinting || !checkerName.trim() || !interactionId.trim()} className="bg-primary hover:bg-primary/90 text-primary-foreground">
